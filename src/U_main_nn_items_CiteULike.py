...
def main():
    print("///**** Main_NN_Items CiteULike ****///")
    data_name = args.data
    dat = load_data_CiteULike.load_data(data_name)
    ...
    np.save('../data/CiteULike/top_k_nn_item_index.npy', top_k_indices_ndarray)
    np.save('../data/CiteULike/top_k_nn_item_sim.npy', top_k_vals_ndarray)
